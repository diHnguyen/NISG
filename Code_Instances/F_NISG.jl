println("\n===========================")
println("Algorithm 1 (LP_IP): F_NISG")
println("===========================")
...
# dataSet = nodeSet*string("_")*density*string("_L")#"N10_d10_"
...
# include("./TestInstances/p_Instances/"*nodeSet*string("_L/")*nodeSet*string("_")*density*"_"*string(ins)*"_L.jl")
...
global constrThetaLazy = Array{JuMP.ScalarConstraint}(undef, 0)
...
function my_callback_function(cb_data, cb_where::Cint)
    ...
    global xplored,constrThetaLazy,start
...
if totalTime >= 60
    timesFile = open("./TestInstances/p_Instances_Output/LP_IP/O_"*dataSet*string(ins)*"_LPIP.txt", "a")
    ...
    timesFile = open("./TestInstances/p_Instances_Output/LP_IP/LessThanAMinutes_LPIP.txt", "a")
