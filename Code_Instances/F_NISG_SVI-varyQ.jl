println("\n===========================")
println("Algorithm 1 (SVI): F_NISG_SVI-varyQ")
println("===========================")
...
dataSet = nodeSet*string("_")*density*_lev #"N30_d10_L"
println(dataSet*string(ins)*"\tRunning..."*myRun)
println("Phase ", phase)
#     include("./TestInstances/"*fileName*".jl")
# global q = []
include("./TestInstances/varyQ/p_Instances/"*nodeSet*_lev*string("/")*nodeSet*string("_")*density*"_"*string(ins)*_lev*".jl")
...
if totalTime >= 60 #180
    timesFile = open("./TestInstances/varyQ/p_Instances_Output/SVI/O_"*dataSet*string(ins)*"_SVI.txt", "a")
    ...
    timesFile = open("./TestInstances/varyQ/p_Instances_Output/SVI/LessThanAMinutes_SVI.txt", "a")
