println("\n===========================")
println("Algorithm 1 (SVI): F_NISG_SVI-varyBM")
println("===========================")
...
dataSet = nodeSet*string("_")*density*"_BM_"*_BM*"_" #"N30_d10_BI3"
println(dataSet*" = "*string(ins)*"\tRunning..."*myRun)
println("Phase ", phase)
#     include("./TestInstances/"*fileName*".jl")
# global q = []
include("./TestInstances/varyBM/p_Instances/"*nodeSet*string("/")*nodeSet*string("_")*density*"_"*string(ins)*".jl")
b_y = parse(Int64, _BM)
# println("b_x = ", b_x)
...
if totalTime >= 60 #180
    timesFile = open("./TestInstances/varyBM/p_Instances_Output/SVI/O_"*dataSet*string(ins)*"_SVI.txt", "a")
    ...
    timesFile = open("./TestInstances/varyBM/p_Instances_Output/SVI/LessThanAMinutes_SVI.txt", "a")
