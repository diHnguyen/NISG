println("\n==============================")
println("Integer Program: F_NISG_IPOnly_linearized")
println("==============================")
...
#Exact Col Gen:
include("./functionIP_ColGen_linearized.jl")
...
#          println(iter, ". x_val = ", findall(x_val.>0), "\t theta_val", theta_val)
#          println("M = ", M_set)
#          println("P = ", P_set)
        #Solve sub problem
#         println("3")
...
# if totalTime >= 60
#     timesFile = open("./TestInstances/p_Instances_Output/IP_Only/O_"*dataSet*string(ins)*"_IPOnly.txt", "a")
...
#     close(timesFile)
# else
#     timesFile = open("./TestInstances/p_Instances_Output/IP_Only/LessThanAMinutes_IPOnly.txt", "a")
